...
namespace Warehouse.Entities.Migrations
{
    ...
    [Migration("20210430193133_add-product-definition")]
            ...
            modelBuilder.Entity("Warehouse.Entities.Models.Article", b =>
                {
                    ...
                    b.Property<DateTime>("UpdateAt")
                        ...
                        .HasDefaultValue(new DateTime(2021, 4, 30, 19, 31, 32, 988, DateTimeKind.Utc).AddTicks(3534));

                    b.Property<string>("UpdateBy")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("DemoUser");
            ...
            modelBuilder.Entity("Warehouse.Entities.Models.Product", b =>
                {
                    ...
                    b.Property<DateTime>("UpdateAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 4, 30, 19, 31, 32, 989, DateTimeKind.Utc).AddTicks(5191));
